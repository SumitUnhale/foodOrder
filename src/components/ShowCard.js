        ...
        <div className="m-4 p-4 text-center">
            ...
            {itemCards.length > 0
                ...
                <>
                    ...
                    <div className="mt-7 w-6/12 m-auto text-end text-sm">
                        <button onClick={handleClearCard} className="hover:bg-white border border-white hover:text-orange-600 hover:border-orange-600 p-2 cursor-pointer bg-orange-600 text-white rounded-lg text-end">Clear Card</button>
                    </div>
                </> 
                :
